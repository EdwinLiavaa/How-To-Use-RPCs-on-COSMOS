...
/* A message type auto-generated from .proto files using ts-proto. @cosmjs/stargate ships some common types but don't rely on those being available. You need to set up your own code generator for the types you care about. How this is done should be documented, but isnot yet: https://github.com/cosmos/cosmjs/issues/640 */
...
const result = await client.signAndBroadcast(firstAccount.address, [msgAny], fee, memo);
